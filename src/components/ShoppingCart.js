...
import { getCartTotalValue, getPriceAfterDiscount } from '../BLL/utilty';
            ...
            <tbody className="align-middle">
              {
                cartState.arrCart.map((e,i)=>(<tr key={i}>
                    ...
                    <td className="align-middle">${getPriceAfterDiscount(e.product.price,e.product.discountPercentage)} <del>{e.product.price}</del></td>
                    <td className="align-middle">
                      <div
                      ...
                      >
                        <div className="input-group-btn">
                          <button onClick={()=>{
                            dispatch(decreaseProduct(e.product))
                        ...
                        <div className="input-group-btn">
                          <button onClick={()=>{
                            dispatch(increaseProduct(e.product))
                    ...
                    <td className="align-middle">
                      <button onClick={()=>{
                            dispatch(removeFromCart(e.product))
